<template>
  <div class="order-right">
    <div class="order-content">
        ...
        <table class="order-item"
         ...
         <tbody>
            ...
            >
              ...
              <!-- 注意除了第一个单元格以外，每行其它的单元格都要合并 -->
              <!-- template是h5新加的一个无意义的标签


              这个标签不是html标签，它是没有任何语义的，它不会影响原有的html结构 -->
      ...
      :showPageNo = '5'
      @ownOrderInfoList = 'ownOrderInfoList'
       ></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
...
export default {
  ...
  mounted() {
      this.ownOrderInfoList()
  },
  methods: {
    async ownOrderInfoList(currentPage = 1){
      this.currentPage = currentPage
      const result =  await this.$API.reqOwnOrderInfo(this.limit,this.currentPage);
      if(result.code == 200){
